...
namespace ReKatarina.ConfigList
{
    public static class Harass
    {
        ...
        static Harass()
        {
            ...
            _HarassWithQ = Menu.Add("Harass.UseQ", new CheckBox("Enable Q in harass mode."));
            Menu.AddGroupLabel("Auto-harass settings");
            _AutoHarassWithQ = Menu.Add("Harass.Auto.UseQ", new CheckBox("Enable auto harass with Q."));
            _AutoHarassChance = Menu.Add("Harass.Auto.Chance", new Slider("Auto harass chance.", 50, 1, 100));
        }
