...
namespace ReKatarina.ConfigList
{
    public static class Misc
    {
        ...
        static Misc()
        {
            ...
            _KSWithQ = Menu.Add("Misc.KillSteal.UseQ", new CheckBox("Enable Kill Steal with Q."));
            _KSWithE = Menu.Add("Misc.KillSteal.UseE", new CheckBox("Enable Kill Steal with E."));
            _KSMinE = Menu.Add("Misc.KillSteal.MinHP", new Slider("Your HP must be >= {0}% to use E / Q+E.", 35, 1, 100));
            Menu.AddGroupLabel("Skin manager");
            _SkinManagerStatus = Menu.Add("Misc.Skin.Status", new CheckBox("Enable skin changer."));
            _SkinManager = Menu.Add("Misc.Skin.Id", new Slider("Select your skin.", 1, 0, 10));
            Menu.AddGroupLabel("Humanizer");
            _EnableHumanizer = Menu.Add("Misc.Humanizer.Status", new CheckBox("Enable humanizer", false));
